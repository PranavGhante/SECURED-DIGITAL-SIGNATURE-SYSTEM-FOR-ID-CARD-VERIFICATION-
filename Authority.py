...
database_info = {
    ...
    "21CSBOA75": "PRANAV SHAILESH GHANTE",
    "21CSBOA63": "UTKARSH RAJ",
    "21CSBOB53": "SHUBHAM SINGHA ROY",
    "21CSBOA34": "TEJAS PAWAN MAKODE",
}
...
database_face = {
    ...
    "21CSBOA34": "15920c9d701e6654a4e01fe92299b03599f057169231b7f3da1a54630242bfb3",
    "21CSBOA75": "2b91b8133f89ffdc5d5a57f72095c27c758a8d47cff0e2aad554a20f73637fd6",
}
...
if flag == 1:
    ...
    for i in range(len(green)):
        val = green[i]
        original_img[val[0] + 500][val[1] + 500] = [tick_r, tick_g, tick_b]
